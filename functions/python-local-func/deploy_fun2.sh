...
APP_NAME="pythonapp"
APP_OCID="ocid1.compartment.oc1..aaaaaaaag7l445t2qcyndkth6kklzp727ki2pls3chnt4wbdsfz7iilnrowa"
NAMESPACE="axnaxy33zwoc"
DOCKER_HOST="$region.ocir.io"
DOCKER_USER="cloudlabs01@gmail.com"
DOCKER_PASS=")+UUVh-Ffe7nu>CAi2E8"
fun_dir="/devops/repo/oci/terraform-oci-iam/functions/python-local-func/pythonfn"
